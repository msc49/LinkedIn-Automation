...
class LinkedInConnections:
  ...
  def connections(self):
    ...
    while self.page <= 5:
      ...
      self.page += 1
      url = f"https://www.linkedin.com/search/results/people/?geoUrn=%5B%2290009496%22%5D&keywords={random.choice(self.roles)}&origin=FACETED_SEARCH&page={self.page}&position=0&schoolFilter=%5B%2212682%22%5D&searchId=4650e789-7233-4870-a8aa-9068b3f8f3cf&sid=xNy"
